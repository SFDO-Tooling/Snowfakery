...
class TestReferences:
    ...
    def test_jinja_reference_to_non_pythonic_names(self, generated_rows):
        yaml = """
        - object: Account
          nickname: The Bluth Company
          fields:
              Name: The Bluth Company
        - object: Contact
          nickname: Kitty Sanchez
          fields:
              FirstName: Kitty
              LastName: Sanchez
              AccountId: ${{reference("The Bluth Company")}}
        """
        generate(StringIO(yaml))
