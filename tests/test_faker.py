...
class TestFaker:
    ...
    @mock.patch("faker.providers.person.en_US.Provider.first_name", wraps=lambda: "Abe")
    @mock.patch(
        "faker.providers.internet.en_US.Provider.ascii_safe_email",
        wraps=lambda: "B@c.com",
    )
